            ...
            <div className=' grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[80%] mx-auto gap-[3rem]'>
                <div className='flex items-center space-x-6'>
                    ...
                    <div>
                        ...
                        <p className='text-[17px] w-[90%] text-white opacity-60'>Panvel,MH</p>
                    </div>
                </div>
                <div className='flex items-center space-x-6'>
                    <div className='md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]'>
                    ...
                    <div>
                        ...
                        <p className='text-[16.5px] w-[90%] text-white opacity-60'>+91 7385994612</p>
                    </div>
                </div>
                <div className='flex items-center space-x-6'>
                    <div className='md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]'>
                ...
                <div className='flex items-center space-x-6'>
                    ...
                    <div>
                        ...
                        <a href='https://github.com/ShivaniMhatre' className='text-[17px] w-[90%] text-white opacity-60'>https://github.com/ShivaniMhatre</a>
                    </div>
                </div>
                <div className='flex items-center space-x-6'>
                    <div className='md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]'>
                    ...
                    <div>
                        ...
                        <a href='https://www.linkedin.com/in/shivani-mhatre-9a139a184' className='text-[17px] w-[90%] text-white opacity-60'>https://www.linkedin.com/in/shivani-mhatre-9a139a184/</a>
                    </div>
                </div>
            </div>
        </div>
